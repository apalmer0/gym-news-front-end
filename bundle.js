...
/***/ function(module, exports, __webpack_require__) {
	...
	var gyms = __webpack_require__(32);
	var users = __webpack_require__(35);
	var climbs = __webpack_require__(38);
	var bulletins = __webpack_require__(44);
	      ...
	      $.ajax({
	        ...
	        if (targetResource === '/gyms/') {
	          ...
	          // users below
	            ...
	            var singleUser = single_entity.user;
	            // for localhost
	...
	var getAllGyms = function getAllGyms(event) {
	  ...
	  $.ajax({
	    ...
	    if (gymsObject.gyms.count !== 0) {
	      ...
	      $('.content-body').empty();
	      $('.action-items').empty();
	      var gymListingTemplate = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"gym","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMyProfile = function getMyProfile(event) {
	  ...
	  $.ajax({
	    ...
	    var singleUser = globalVariables.me;
	    $('.content-body').empty();
	    $('.action-items').empty();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var openEditClimbModal = function openEditClimbModal(event) {
	  ...
	  $.ajax({
	    ...
	    var editClimbTemplate = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var climbVariables = __webpack_require__(40);
	var climbNumber = 0;
	...
	$('.color-options').on('click', 'div', function () {
	  ...
	  if ($(this).hasClass('create-active')) {
	    ...
	    var newClimbTemplate = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setUpNewBulletinForm = function setUpNewBulletinForm(event) {
	  ...
	  var newBulletinTemplate = __webpack_require__(45);
