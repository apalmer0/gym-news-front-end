...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  ...
	  var getGymsBulletins = function getGymsBulletins(gym) {
	    $.ajax({
	  ...
	  $('.action-items').on('click', 'button', function () {
	    if ($(this).hasClass('new-bulletin-button')) {
	      ...
	      $('.content-body').prepend(newBulletinTemplate({ gymId: gymId }));
	    }
	  });
	  // vvvv create the new bulletin FORM (not the actual bulletin) vvvv
	      ...
	      (function () {
	        ...
	        $.ajax({
	          ...
	          if (targetResource === '/gyms/') {
	            ...
	            $('.action-items').empty();
	            var climbButtonTemplate = __webpack_require__(43);
	            $('.action-items').append(climbButtonTemplate(single_entity));
	            var bulletinButtonTemplate = __webpack_require__(44);
	  ...
	  $('.content-body').on('click', 'button.delete-climb-button', function () {
	    event.preventDefault();
	    var climbId = $(this)[0].dataset.deleteClimbId;
	    console.log(climbId);
	    $.ajax({
	      url: myApp.baseUrl + '/climbs/' + climbId,
	      headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"story climbNumber"
	    ...
	    + "</div>\n    </div>\n    <div class=\"story-body col-md-10\">\n      Holy shit check it out this worked!!!\n      Wahooooooooooooo!!!\n      <br>\n      <button type=\"button\" data-toggle=\"modal\" data-target=\"#editClimbModal\"class=\"modal-button btn btn-default edit-climb-button\" data-edit-climb-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n        Edit\n      </button>\n      <button type=\"button\" class=\"btn btn-default delete-climb-button\" data-delete-climb-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n        Delete\n      </button>\n      <button type=\"button\" class=\"btn btn-default favorite-climb-button\" data-favorite-climb-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n        Favorite\n      </button>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<script>console.log('new bulletin handlebars');</script>\n<div class=\"story\">\n  <div class=\"row\">\n    <div class=\"story-header col-md-2\">\n      <img class=\"bulletin-thumbnail\" src=\"assets/images/create.png\">\n    </div>\n    <div class=\"story-body col-md-10\">\n      <form id=\"new-bulletin\">\n        <input type=\"text\" class=\"form-control\" id=\"inputBulletinContent\" placeholder=\"content\" name=\"bulletin[content]\" value=\"\">\n        <input type=\"hidden\" class=\"form-control\" id=\"inputBulletinGymId\" name=\"bulletin[gym_id]\" value=\""
	    ...
	    + "\">\n        <div class=\"modal-footer\">\n          <button type=\"submit\" name=\"submit\" class=\"btn btn-success create-bulletin-button\" data-gym-id=\""
	    + alias4(((helper = (helper = helpers.gymId || (depth0 != null ? depth0.gymId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"gymId","hash":{},"data":data}) : helper)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<button class=\"logged-in modal-button new-climb-button\" data-gym-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#addClimbModal\" href=\"#\">Add climb to "
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<button class=\"logged-in modal-button new-bulletin-button\" data-gym-id=\""
